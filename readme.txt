...
Installation
	...
	Include the package's "/path/to/baseball-tools/connect.php" (e.g. include("baseball-tools/connect.php");)
...
Usage
	...
	Function/method list is as follows: (see code comments for instructions on their usage)
		get_age ()
		get_bats ()
		get_bbref_id ()
		get_birthday ()
...
Version 0.001 Alpha 
	Introducing a PHP library for that is compatible with Sean Forman's Baseball 
	Databank database or Sean Lahman's Baseball Database. This is still in a beta 
	format and it currently only provides statistics for batters, I am working on 
	adding pitcher's for the next release.
